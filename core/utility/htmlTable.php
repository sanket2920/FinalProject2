...
class htmlTable
{
	...
	foreach($array as $record) {
		...
		$tableGen.='<td><ahref="index.php?page='.$referingPage.'&action=show&id=' . $id1 . '"><span class="glyphicon glyphicon-pencil">edit</span></a></td>';
		$tableGen .= '<td><a href="index.php?page=' . $referingPage . '&action=edit&id=' . $id1 . '"> <span class="glyphicon
		glyphicon-trash">delete</span></a></td>';
		$id1='';
		$tableGen .= '</tr>';
	}
